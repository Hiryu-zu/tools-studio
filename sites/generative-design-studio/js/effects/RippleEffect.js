...
export class RippleEffect {
    constructor() {
        ...
        Object.defineProperty(this, "simScene", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "simCamera", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "simQuad", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "updateMat", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "renderMat", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "rtA", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "rtB", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "simW", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "simH", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "bgAspect", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "lastPointer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastAuto", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    initSimTargets() {
        ...
        if (aspect >= 1) {
            this.simW = maxDim;
            this.simH = Math.max(2, Math.round(maxDim / aspect));
        }
        else {
            this.simH = maxDim;
            this.simW = Math.max(2, Math.round(maxDim * aspect));
        }
        const opts = {
    ...
    fitBackground() {
        ...
        if (canvasAspect > this.bgAspect) {
            sx = this.bgAspect / canvasAspect;
            ox = (1 - sx) / 2;
        }
        else {
            sy = canvasAspect / this.bgAspect;
            oy = (1 - sy) / 2;
        }
    ...
    frame(timeMs, _dt) {
        if (this.params.autoRipple && timeMs - this.lastAuto > 2200) {
            ...
            this.addDrop(0.15 + Math.random() * 0.7, 0.15 + Math.random() * 0.7, 0.5 + Math.random() * 0.3, 0.05 + Math.random() * 0.04);
        }
