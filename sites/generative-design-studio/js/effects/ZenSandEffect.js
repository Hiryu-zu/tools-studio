...
export class ZenSandEffect {
    constructor() {
        ...
        Object.defineProperty(this, "rocks", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
        });
        Object.defineProperty(this, "rockCount", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "writeIdx", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    init(c) {
        ...
        for (let i = 0; i < 8; i++)
            this.rocks.push(new THREE.Vector2(0, 0));
        const defaults = [
            [-0.35, 0.12], [0.18, -0.08], [0.5, 0.22], [-0.05, -0.25],
        ];
        for (let i = 0; i < defaults.length; i++)
            this.rocks[i].set(defaults[i][0], defaults[i][1]);
